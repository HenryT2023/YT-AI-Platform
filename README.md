...
| v0.4.0 | AI 增强：智能推荐 + 个性化体验 | ✅ 已完成 |
| v0.5.0 | 向量化推荐与语义检索 | ✅ 已完成 |
| v0.6.0 | 多站点支持与运营管理 | ✅ 已完成 |
| v1.0.0 | 生产就绪与运维体系 | ✅ 已完成 |

### v1.0.0 更新内容 (2024-12-20)
...
### v0.6.0 更新内容 (2024-12-20)

**多站点支持**
- Site 模型扩展（features、operating_hours、contact_info）
- SiteStatsDaily 站点统计表
- 站点管理服务（CRUD、配置、统计、初始化）

**站点管理 API**
- `/api/v1/site-management` 完整 CRUD
- 站点配置与初始化接口
- 运营统计接口
...
### v0.5.0 更新内容 (2024-12-20)

**向量化推荐**
- EmbeddingService（OpenAI/DashScope）
- VectorStore（Qdrant 封装）
- 数据向量化脚本

**语义检索**
- `/api/v1/search/semantic` 语义搜索 API
- 混合推荐引擎（向量 + 规则）

### v0.4.0 更新内容 (2024-12-20)

**智能推荐**
- 首页推荐 API（节气问候、推荐话题、成就提示）
- 游客上下文服务
- 环境感知推荐
